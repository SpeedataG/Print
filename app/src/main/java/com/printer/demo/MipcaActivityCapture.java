...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//ViewUtil.addTopView(g	·etApplicationContext(), this, R.string.scan_card);
...
//		characterSet = null;
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			//用默认浏览器打开扫描得到的地址
			Log.i(TAG, "扫描得到的文本内容"+scanResult);
...
//				}else{
//				Toast.makeText(MipcaActivityCapture.this, "url为空", Toast.LENGTH_LONG).show();
//
...
//
//			}else{
////				Intent intent1 = new Intent(MipcaActivityCapture.this,ShowResult.class);
////				intent1.putExtra("context", result.getText());
////				startActivity(intent1);
//			}
		}
			Intent intent = new Intent();
			intent.putExtra(BluetoothDeviceList.EXTRA_DEVICE_ADDRESS, scanResult);
