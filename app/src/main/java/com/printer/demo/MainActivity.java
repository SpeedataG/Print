...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout llTestPrint;
    ...
    private void init() {
        ...
        llTestPrint = (LinearLayout) findViewById(R.id.ll_test);
        llTestPrint.setOnClickListener(this);
        // 设置点击监听事件
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    URL url = new URL(getString(R.string.serverur2));
                    // 联网
