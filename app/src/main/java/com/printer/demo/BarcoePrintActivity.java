...
import com.printer.demo.utils.IsChineseOrNot;
...
public class  BarcoePrintActivity extends BaseActivity implements OnItemSelectedListener, CompoundButton.OnCheckedChangeListener, OnClickListener {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					if (PrinterInstance.mPrinter == null) {
						...
						PrinterInstance.mPrinter.setPrinter(
								Command.PRINT_AND_WAKE_PAPER_BY_LINE, 6);
						PrinterInstance.mPrinter.cutPaper(49,0);
						PrinterInstance.mPrinter.setPrinter(
								Command.ALIGN,
								Command.ALIGN_LEFT);
					}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == SCANNIN_GREQUEST_CODE) {
			...
			try {
				...
				UTF_Str=new String(barcodeContent.getBytes("ISO-8859-1"),"UTF-8");
				...
				if(!is_cN){
					GB_Str=new String(barcodeContent.getBytes("ISO-8859-1"),"GB2312");
			...
			if(is_cN){
				barcodeContent = UTF_Str;
			}else{
				barcodeContent = GB_Str;
