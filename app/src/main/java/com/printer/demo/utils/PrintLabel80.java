...
public class PrintLabel80 {
	...
	public  void doPrint(PrinterInstance iPrinter, Resources resources){
...
//		drawRowContent(iPrinter);
		iPrinter.drawGraphic(100,100,0,0,bitmap1);
		iPrinter.drawGraphic(200,200,0,0,bitmap1);
	...
	private void drawRowContent(PrinterInstance iPrinter) {
		...
		// 第一行内容
		iPrinter.drawText(area_start_x, area_start_y, bottom_right_x,
				top_left_y + row_height[0] - line_width_border, PAlign.CENTER,
				PAlign.CENTER, "定时达", LableFontSize.Size_64, 1, 0, 0, 0,
				PRotate.Rotate_0);
		// 第二行内容
		iPrinter.drawText(top_left_x, top_left_y + row_height[0],
				bottom_right_x, top_left_y + row_height[0] + row_height[1],
				PAlign.CENTER, PAlign.CENTER, "DF1234567890",
				LableFontSize.Size_64, 1, 0, 0, 0, PRotate.Rotate_0);
		// 第三行内容 左边栏内容
		iPrinter.drawText(top_left_x+6, top_left_y + row_height[0]
				+ row_height[1], top_left_x + row_height[1], top_left_y//+3弥补边框线宽误差
				+ row_height[0] + row_height[1] * 2, PAlign.CENTER,
				PAlign.CENTER, "目的 分拨 ", LableFontSize.Size_24, 1, 0, 0, 0,
				PRotate.Rotate_0);
		// 第三行内容 中间栏内容
		iPrinter.drawText(top_left_x + row_height[1], top_left_y
				+ row_height[0] + row_height[1], top_left_x + 3
				* (top_right_x - top_left_x) / 4, top_left_y + row_height[0]
				+ row_height[1] * 2, PAlign.CENTER, PAlign.CENTER, "西安分拨中心",
				LableFontSize.Size_32, 1, 0, 0, 0, PRotate.Rotate_0);
		// 第三行内容 右边栏内容
		iPrinter.drawText(top_left_x + 3 * (top_right_x - top_left_x) / 4,
				top_left_y + row_height[0] + row_height[1], bottom_right_x,
				top_left_y + row_height[0] + row_height[1] * 2, PAlign.CENTER,
				PAlign.CENTER, "第1件", LableFontSize.Size_24, 0, 0, 0, 0,
				PRotate.Rotate_0);

		// 第四行内容 左边栏内容
		iPrinter.drawText(top_left_x+6, top_left_y + row_height[0]
				+ row_height[1]*2, top_left_x + row_height[1]+3, top_left_y
				+ row_height[0] + row_height[1] * 3, PAlign.CENTER,
				PAlign.CENTER, "到达 网点 ", LableFontSize.Size_24, 1, 0, 0, 0,
				PRotate.Rotate_0);
		// 第四行内容 中间栏内容
		iPrinter.drawText(top_left_x + row_height[1], top_left_y
				+ row_height[0] + row_height[1]*2, top_left_x + 3
				* (top_right_x - top_left_x) / 4, top_left_y + row_height[0]
				+ row_height[1] * 3, PAlign.CENTER, PAlign.CENTER, "西安长线",
				LableFontSize.Size_32, 0, 0, 0, 0, PRotate.Rotate_0);
		// 第四行内容 右边栏内容
		iPrinter.drawText(top_left_x + 3 * (top_right_x - top_left_x) / 4,
				top_left_y + row_height[0] + row_height[1]*2, bottom_right_x,
				top_left_y + row_height[0] + row_height[1] * 3, PAlign.CENTER,
				PAlign.CENTER, "1", LableFontSize.Size_24, 1, 0, 0, 0,
				PRotate.Rotate_0);
		// 第五行内容 左边栏内容
		iPrinter.drawText(top_left_x+6, top_left_y + row_height[0]
				+ row_height[1] * 3, top_left_x + row_height[1]+3, top_left_y
				+ row_height[0] + row_height[1] * 4, PAlign.CENTER,
				PAlign.CENTER, "出发 网点 ", LableFontSize.Size_24, 1, 0, 0, 0,
				PRotate.Rotate_0);
		// 第五行内容 中间栏内容
		iPrinter.drawText(top_left_x + row_height[1], top_left_y
				+ row_height[0] + row_height[1] * 3+6, top_left_x + 3 //+6弥补线宽的误差
				* (top_right_x - top_left_x) / 4, top_left_y + row_height[0]
				+ row_height[1] * 4, PAlign.CENTER, PAlign.CENTER, "测试二级网点         (2016-05-31 19:02)",
				LableFontSize.Size_32, 0, 0, 0, 0, PRotate.Rotate_0);
		// 第五行内容 右边栏内容
		iPrinter.drawText(top_left_x + 3 * (top_right_x - top_left_x) / 4,
				top_left_y + row_height[0] + row_height[1] * 3, bottom_right_x,
				top_left_y + row_height[0] + row_height[1] * 5, PAlign.CENTER,
				PAlign.CENTER, "袋装", LableFontSize.Size_24, 1, 0, 0, 0,
				PRotate.Rotate_0);

		// 第六行内容 左边栏内容
		iPrinter.drawText(top_left_x+6, top_left_y + row_height[0]
				+ row_height[1] * 4, top_left_x + row_height[1]+3, top_left_y
				+ row_height[0] + row_height[1] * 5, PAlign.CENTER,
				PAlign.CENTER, "详细 地址 ", LableFontSize.Size_24, 1, 0, 0, 0,
				PRotate.Rotate_0);
		// 第六行内容 中间栏内容
		iPrinter.drawText(top_left_x + row_height[1], top_left_y
				+ row_height[0] + row_height[1] * 4, top_left_x + 3
				* (top_right_x - top_left_x) / 4, top_left_y + row_height[0]
				+ row_height[1] * 5, PAlign.CENTER, PAlign.CENTER, "陕西省西安市临潼区秦始皇陵兵马俑一号坑五排三列俑",
				LableFontSize.Size_24, 0, 0, 0, 0, PRotate.Rotate_0);

		//打印第七行条码

		iPrinter.drawBarCode(top_left_x, top_left_y+ row_height[0] + row_height[1] * 5, top_left_x + 3
				* (top_right_x - top_left_x) / 4, bottom_right_y, PAlign.CENTER, PAlign.CENTER, 0, 0,
				"DF12345678900010292001", PBarcodeType.CODE128, 1, 70, PRotate.Rotate_0);

		//打印第七行条码下方的文字
		iPrinter.drawText(top_left_x,top_left_y+ row_height[0] + row_height[1] * 5+110, top_left_x + 3
				* (top_right_x - top_left_x) / 4,bottom_right_y, PAlign.CENTER,PAlign.CENTER, "DF12345678900010292001",
				LableFontSize.Size_24, 1, 0, 0, 0,PRotate.Rotate_0);

		// 第五行内容 右边栏内容
		iPrinter.drawText(top_left_x + 3 * (top_right_x - top_left_x) / 4,
				top_left_y + row_height[0] + row_height[1] * 5, bottom_right_x,
				bottom_right_y, PAlign.CENTER,PAlign.CENTER, "派送", LableFontSize.Size_48, 1, 0, 0, 0,PRotate.Rotate_0);
	}
